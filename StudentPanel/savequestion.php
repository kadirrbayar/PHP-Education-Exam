            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Test Kaydet</h4>
                                <p class="card-description">
                                    Burada hazırlamış olduğunuz soruları test olarak kaydedebilirsiniz. Testiniz için bir isim girin.
                                </p>
                                <form class="forms-sample" action="questionpost.php" method="post">
                                    <div class="form-group">
                                        <label for="exampleInputUsername1">Test Adı</label>
                                        <input type="text" class="form-control" name="title" placeholder="Test Adı">
                                    </div>
                                    <div class="form-group">
